...
# ---[ Boost
find_package(Boost 1.67 REQUIRED COMPONENTS system thread filesystem)
...
if(BUILD_python)
  if(NOT "${python_version}" VERSION_LESS "3.0.0")
    ...
    find_package(Boost 1.67 COMPONENTS "python${boost_py_version}")
    ...
    if(NOT Boost_PYTHON_FOUND)
      find_package(Boost 1.67 COMPONENTS python)
    endif()
  else()
